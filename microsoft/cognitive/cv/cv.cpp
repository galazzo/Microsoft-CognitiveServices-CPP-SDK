...
void Microsoft::CognitiveServices::ComputerVision::ToFile(std::string filename, ios_base::openmode mode, const char* buffer, int size) {
...
std::string Microsoft::CognitiveServices::ComputerVision::ApiServer(ApiServerRegion region)
{
    std::string result;
