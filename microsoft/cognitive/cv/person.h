...
void Microsoft::CognitiveServices::ComputerVision::Person::CreateGroup(HttpContent* data, std::string subscriptionKey, std::string ContentType="application/octet-stream");
